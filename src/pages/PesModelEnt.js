...
export default function PesModelEnt() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const api_url = "http://192.168.12.58:5000/api/queryEnt";
  ...
  const handleExportExcel = async () => {
    try {
      ...
      const response = await axios.get("http://192.168.12.58:5000/api/exportEnt/excel", {
        params: exportParams,
        responseType: "blob",
      });
